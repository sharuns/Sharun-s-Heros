...
set CommonCompilerFlags=-MTd -nologo -fp:fast -GR- -EHa- -Oi -WX -W4 -wd4201 -wd4100 -wd4189 -wd4211 -wd4244 -wd4505  -DSHARUN_DEBUG_SLOW=1 -DSHARUN_INTERNAL=1 -DSHARUN_WIN32 -FC -Z7
